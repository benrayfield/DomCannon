...
CANNON.Demo = function(options){
    ...
    function init() {
		...
		//light.position.set( 130, 30, 140 );
        //light.target.position.set( 0, 0, 0 );
		light.target.position.set( 88, 88, 0 );
		...
		//controls.dynamicDampingFactor = 0.001;
		//controls.dynamicDampingFactor = 30;
